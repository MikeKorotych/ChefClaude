...
const SYSTEM_INSTRUCTIONS = `Always give an answer in the same language in which the user data is received. Always use emoji to style your answer. Indicate units of measurement in the answer in grams (in this system of measurement)`;
